...
export default function VatFloatingButton(){
 ...
 if(!user)return null
 return <a href="/vat" aria-label="Ouvrir la saisie TVA" style={{position:'fixed',right:18,bottom:18,zIndex:1000,background:'#405944',color:'white',textDecoration:'none',fontWeight:800,padding:'12px 16px',borderRadius:14,boxShadow:'0 6px 20px rgba(0,0,0,.18)'}}>HT · TVA · TTC</a>
}
